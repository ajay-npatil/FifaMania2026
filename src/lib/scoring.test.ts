...
describe("scorePrediction", () => {
  ...
  it("adds 35 for an exact draw with the correct shootout winner", () => {
    ...
    ).toBe(100); // 65 exact draw + 35 shootout
  });
  ...
  it("adds 35 to a non-exact draw with the correct shootout winner", () => {
